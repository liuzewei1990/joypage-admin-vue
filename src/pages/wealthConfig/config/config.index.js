 ...
 * @LastEditTime: 2021-05-19 15:16:06
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \finsuit-admin-joypage\src\pages\wealthConfig\config\config.index.js
 */
...
const CONFIG = {
    ...
    production: {
        ...
        // baseUrlHost: (window.location.protocol + '//' + window.location.host) + "/finsuit",   //生产和灰度环境
