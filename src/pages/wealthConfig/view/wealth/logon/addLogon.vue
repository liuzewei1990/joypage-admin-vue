    ...
    <div class="editAdvertPosit">
        <el-form :size="size" ref="form" :rules="rules" :model="form" label-width="140px">
            <el-form-item class="imgDiv" label="图片：" prop="imgUrl">
                <el-upload :model="form.imgUrl" accept="image/*" class="upload-demo upload-demo1" action="customize" :http-request="uploadCheckImg" :show-file-list="false">
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    buttonName: [{ required: true, message: "请输入按钮名称", trigger: "change" }],
                    appFlag: [{ required: true, message: "请选择渠道", trigger: "change" }],
                    systemType: [{ required: true, message: "请选择设备", trigger: "change" }],
