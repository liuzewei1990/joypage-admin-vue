        ...
        <CommonTable :isFluid="false" @height="tableHeight = $event">
            ...
            <el-table :height="tableHeight" :data="contentList" style="width: 100%" border="true">
                ...
                <el-table-column min-width="110px" prop="seqOrder" label="排序" header-align="center" align="center">
                    <template slot-scope="scope">
                        <i v-if="scope.$index == 0" style="color: #c1c1c1; font-size: 1.3rem" class="el-icon-top paixu" title="向上移动一位"></i>
                        <i v-else @click="yiwei('up', scope.row, scope.$index)" class="el-icon-top paixu" title="向上移动一位" style="color: #000; font-size: 1.3rem"></i>
                        <span>{{ scope.row.seqOrder }}</span>

                        <i v-if="scope.$index == contentList.length - 1" class="el-icon-bottom paixu" title="向下移动一位" style="color: #c1c1c1; font-size: 1.3rem"></i>
                        <i v-else @click="yiwei('down', scope.row, scope.$index)" class="el-icon-bottom paixu" title="向下移动一位" style="color: #000; font-size: 1.3rem"></i>
                    </template>
                </el-table-column>
