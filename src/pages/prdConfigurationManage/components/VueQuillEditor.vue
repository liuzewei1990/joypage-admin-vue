<template>
    <div>
        ...
        <el-card v-loading="uillUpdateImg">
            <quill-editor class="editor" v-model="detailContent" ref="myQuillEditor" :options="editorOption" @change="onEditorChange($event)" @ready="onEditorReady($event)"> </quill-editor>
...
<script>
    const toolbarOptions = [
        ...
        [{ align: [] }], // 对齐方式
        ["clean"], // 清除文本格式
        ["link", "image", "video"][("link", "image")] // 链接、图片、视频 // 链接、图片
    ];
    export default {
        name: "VueQuillEditor",
        data() {
