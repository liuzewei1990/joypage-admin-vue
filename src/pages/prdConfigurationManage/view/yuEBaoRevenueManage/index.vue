    ...
    <div class="productDrawingManage">
        ...
        <div class="table">
            ...
            <el-table
                ...
                <el-table-column prop="ID" label="七日年化（%）" width="100" header-align="center" align="center"></el-table-column>
                <el-table-column prop="ORG_NAME" label="万份收益" header-align="center" align="center"></el-table-column>
                <el-table-column prop="PRD_TYPE_NAME" label="收益日期" header-align="center" align="center"></el-table-column>
