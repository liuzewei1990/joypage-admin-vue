    ...
    <div class="productDrawingManage">
        ...
        <div class="topBox">
            <el-form :inline="true" :model="topCheckData" :size="size" ref="topCheckData">
                <el-form-item label="币种大类：">
                    <el-select v-model="topCheckData.orgName" placeholder="请选择机构名称" clearable>
                        <el-option v-for="item in allSelectData.orgList" :key="item.ID" :label="item.ORG_NAME" :value="item.ID"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="币种名称：">
                    <el-select v-model="topCheckData.typeCode" placeholder="请选择存款类型" clearable>
                        <el-option v-for="item in allSelectData.allSubTypeList" :key="item.typeCode" :label="item.typeName" :value="item.typeCode"> </el-option>
                    </el-select>
                </el-form-item>
        ...
        <div class="table">
            ...
            <el-table
                ...
                <el-table-column prop="PRD_TYPE" label="币种大类" header-align="center" align="center"></el-table-column>
                <el-table-column prop="PRD_TYPE_NAME" label="币种简称" header-align="center" align="center"></el-table-column>
                <el-table-column prop="PRD_SERIES_NAME" label="币种名称" header-align="center" align="center"></el-table-column>
                <el-table-column prop="PRD_SERIES_NAME" label="币种分类" header-align="center" align="center"></el-table-column>
                <el-table-column prop="AUTO_UPPER" label="币种排序" header-align="center" align="center"></el-table-column>
        ...
        <el-dialog :title="!dataForm.ID ? '新增' : '修改'" width="60%" :visible.sync="dialogVisible">
            <el-form :model="dataForm" label-width="auto" :rules="formRules" ref="dataForm" :size="size" label-position="left" class="addForm">
                <el-form-item label="币种大类：" prop="ORG_ID">
                    <el-select v-model="dataForm.ORG_ID" placeholder="请选择机构名称" clearable @change="orgListSelect">
                        <el-option v-for="item in allSelectData.orgList" :key="item.ID" :label="item.ORG_NAME" :value="item.ID"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="币种简称：" prop="PRD_SERIES_NAME">
                    <el-input v-model="dataForm.PRD_SERIES_NAME"></el-input>
                </el-form-item>
                <el-form-item label="币种名称：" prop="PRD_SERIES_NAME">
                    <el-input v-model="dataForm.PRD_SERIES_NAME"></el-input>
                </el-form-item>
                <el-form-item label="单位" prop="PRD_SERIES_NAME">
                    <el-input v-model="dataForm.PRD_SERIES_NAME"></el-input>
                </el-form-item>
                <el-form-item label="是否热门推荐：" prop="PRD_TYPE">
                    <el-select v-model="dataForm.PRD_TYPE" placeholder="请选择产品大类" clearable @change="parentTypeListSelect">
                        <el-option v-for="item in allSelectData.parentTypeList" :key="item.id" :label="item.typeName" :value="item.typeCode"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="是否选中：" prop="SUBTYPE">
                    <el-select v-model="dataForm.SUBTYPE" placeholder="请选择产品类型" clearable @change="allSubTypeListSelect">
                        <el-option v-for="item in allSelectData.allSubTypeList" :key="item.id" :label="item.typeName" :value="item.typeCode"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="是否显示：" prop="SUBTYPE">
                    <el-select v-model="dataForm.SUBTYPE" placeholder="请选择产品类型" clearable @change="allSubTypeListSelect">
                        <el-option v-for="item in allSelectData.allSubTypeList" :key="item.id" :label="item.typeName" :value="item.typeCode"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="币种分类：" prop="SUBTYPE">
                    <el-select v-model="dataForm.SUBTYPE" placeholder="请选择产品类型" clearable @change="allSubTypeListSelect">
                        <el-option v-for="item in allSelectData.allSubTypeList" :key="item.id" :label="item.typeName" :value="item.typeCode"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="币种排序：" prop="RATE_NAME">
                    <el-input v-model="dataForm.RATE_NAME"></el-input>
                </el-form-item>
                <el-form-item label="币种备注：" prop="ATTR_ADDED_LABEL">
                    <el-input v-model="dataForm.ATTR_ADDED_LABEL"></el-input>
                </el-form-item>
            </el-form>
    ...
    export default {
        ...
        data() {
            return {
                ...
                formRules: {
                    //弹框校验规则
                    ORG_ID: [{ required: true, message: "请选择机构名称", trigger: "blur" }],
                    PRD_TYPE: [{ required: true, message: "请选择产品大类", trigger: "change" }],
                    SUBTYPE: [{ required: true, message: "请选择产品类型", trigger: "change" }],
                    // PRD_SERIES_NAME:[
