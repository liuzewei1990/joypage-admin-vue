    ...
    <div class="productDrawingManage">
        ...
        <div class="table">
            ...
            <el-table
                ...
                <el-table-column prop="ORG_NAME" label="产品名称" header-align="center" align="center"></el-table-column>
                ...
                <el-table-column prop="UPDATE_USER" label="收益日期" header-align="center" align="center"></el-table-column>
                <el-table-column prop="UPDATE_TIME" label="状态" header-align="center" align="center"></el-table-column>
        ...
        <!-- 保险理财-修改弹框 -->
        <el-dialog :title="!dataForm.ID == 1 ? '保险理财' : '货币基金'" width="60%" :visible.sync="dialogVisible">
            <el-form :model="dataForm" label-width="auto" :rules="formRules" ref="dataForm" :size="size" label-position="left" class="addForm">
                <el-form-item label="产品名称：" prop="PRD_SERIES_NAME">
                    <el-input v-model="dataForm.PRD_SERIES_NAME"></el-input>
                </el-form-item>
                <el-form-item label="收益日期：" prop="ORG_ID">
                    <el-date-picker v-model="dataForm.value1" type="date" placeholder="选择日期"> </el-date-picker>
                </el-form-item>
                <el-form-item label="七日年化（%）：" prop="PRD_SERIES_NAME">
                    <el-input v-model="dataForm.PRD_SERIES_NAME"></el-input>
                </el-form-item>
                <el-form-item label="万份收益：" prop="RATE_NAME">
		...
		<el-form :model="dataForm" label-width="auto" :rules="formRules" ref="dataForm" :size="size"
			...
			<el-form-item label="收益日期：" prop="ORG_ID">
				<el-date-picker v-model="dataForm.value1" type="date" placeholder="选择日期">
				</el-date-picker>
			</el-form-item>
			<el-form-item label="七日年化（%）：" prop="PRD_SERIES_NAME">
				<el-input v-model="dataForm.PRD_SERIES_NAME"></el-input>
        ...
        <el-dialog :title="!dataForm.ID ? '新增' : '修改'" width="60%" :visible.sync="dialogVisible">
            <el-form :model="dataForm" label-width="auto" :rules="formRules" ref="dataForm" :size="size" label-position="left" class="addForm">
                ...
                <el-form-item label="单位净值：" prop="PRD_SERIES_NAME">
                    <el-input v-model="dataForm.PRD_SERIES_NAME"></el-input>
                </el-form-item>
                <el-form-item label="累计净值：" prop="RATE_NAME">
                    <el-input v-model="dataForm.RATE_NAME"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
