    ...
    <div class="productDrawingManage">
        ...
        <div class="topBox">
            <el-form :inline="true" :model="topCheckData" :size="size" ref="topCheckData">
                ...
                <el-form-item label="产品状态标签：">
                    <el-select v-model="topCheckData.typeCode" placeholder="请选择存款类型" clearable>
                        <el-option v-for="item in allSelectData.allSubTypeList" :key="item.typeCode" :label="item.typeName" :value="item.typeCode"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="标签展示状态：">
                    <el-select v-model="topCheckData.typeCode" placeholder="请选择存款类型" clearable>
                        <el-option v-for="item in allSelectData.allSubTypeList" :key="item.typeCode" :label="item.typeName" :value="item.typeCode"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="展示日期：">
                    <el-date-picker v-model="topCheckData.updDate" type="daterange" range-separator="~" start-placeholder="开始日期" end-placeholder="结束日期"> </el-date-picker>
                </el-form-item>
        ...
        <div class="table">
            ...
            <el-table
                ...
                <el-table-column prop="ID" label="产品ID" width="100" header-align="center" align="center"></el-table-column>
                <el-table-column prop="PRD_TYPE_NAME" label="产品类型" header-align="center" align="center"></el-table-column>
                <el-table-column prop="PRD_SERIES_NAME" label="产品系列" header-align="center" align="center"></el-table-column>
                <el-table-column prop="PRD_SERIES_NAME" label="产品名称" header-align="center" align="center"></el-table-column>
                <el-table-column prop="PRD_SERIES_NAME" label="产品状态标签" header-align="center" align="center"></el-table-column>
                <el-table-column prop="PRD_SERIES_NAME" label="标签展示状态" header-align="center" align="center"></el-table-column>
                <el-table-column prop="UPDATE_TIME" label="展示日期" header-align="center" align="center"></el-table-column>
        ...
        <el-dialog :title="!dataForm.ID ? '新增' : '修改'" width="60%" :visible.sync="dialogVisible">
            <el-form :model="dataForm" label-width="auto" :rules="formRules" ref="dataForm" :size="size" label-position="left" class="addForm">
                <el-form-item label="产品类型：" prop="SUBTYPE">
                    <el-select v-model="dataForm.SUBTYPE" placeholder="请选择" clearable @change="allSubTypeListSelect">
                        <el-option v-for="item in allSelectData.allSubTypeList" :key="item.id" :label="item.typeName" :value="item.typeCode"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="产品系列：" prop="PRD_TYPE">
                    <el-select v-model="dataForm.PRD_TYPE" placeholder="请选择" clearable @change="parentTypeListSelect">
                ...
                <el-form-item label="产品状态标签：" prop="ORG_ID">
                    <el-select v-model="dataForm.ORG_ID" placeholder="请选择" clearable @change="orgListSelect">
                        <el-option v-for="item in allSelectData.orgList" :key="item.ID" :label="item.ORG_NAME" :value="item.ID"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="展示日期：">
                ...
                <el-form-item v-if="dataForm.ID" label="是否手动停止展示：" prop="ORG_ID">
                    <!-- 默认为否 -->
                    <el-select v-model="dataForm.ORG_ID" placeholder="请选择" clearable @change="orgListSelect">
                        <el-option v-for="item in allSelectData.orgList" :key="item.ID" :label="item.ORG_NAME" :value="item.ID"> </el-option>
                    </el-select>
