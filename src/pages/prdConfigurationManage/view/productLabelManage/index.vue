	...
	<el-dialog :title="!dataForm.ID ? '新增' : '修改'" width="60%" :visible.sync="dialogVisible">
		<el-form :model="dataForm" label-width="auto" :rules="formRules" ref="dataForm" :size="size"
			...
			<el-form-item label="产品类型：" prop="SUBTYPE">
				<el-select v-model="dataForm.SUBTYPE" placeholder="请选择" clearable
			...
			<el-form-item label="产品系列：" prop="PRD_TYPE">
				<el-select v-model="dataForm.PRD_TYPE" placeholder="请选择" clearable
			...
			<el-form-item label="产品状态标签：" prop="ORG_ID">
				<el-select v-model="dataForm.ORG_ID" placeholder="请选择" clearable
