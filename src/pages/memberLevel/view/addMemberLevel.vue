    ...
    <div class="addShare">
        <el-form :size="size" ref="form" :rules="rules" :model="form" label-width="160px">
            <el-form-item label="等级名称：" prop="lvName">
                <el-input placeholder="请输入等级名称" show-word-limit v-model="form.lvName"></el-input>
            </el-form-item>
            <el-form-item label="等级图标：" prop="lvLogo">
                <el-upload :model="form.lvLogo" class="upload-demo upload-demo1" action="customize" :http-request="uploadCheckImg1" :on-change="fileChange" :show-file-list="false">
            ...
            <el-form-item label="会员等级：" prop="userLv">
                <el-input placeholder="请输入会员等级" show-word-limit v-model="form.userLv"></el-input>
            </el-form-item>
            <el-form-item label="会员等级编号：" prop="lvCode">
                <el-input placeholder="请输入会员等级编号" show-word-limit v-model="form.lvCode"></el-input>
            </el-form-item>
            <el-form-item label="经验值：" prop="exp">
                <el-input placeholder="请输入经验值" show-word-limit v-model="form.exp"></el-input>
            </el-form-item>
            <el-form-item label="积分加成：" prop="integralUp">
                <el-input placeholder="请输入积分加成" show-word-limit v-model="form.integralUp"></el-input>
            </el-form-item>
            <el-form-item label="等级说明：" prop="lvDescribe">
                <quill-editor id="editor1" @onEditorChange="onEditorChangeDeal" :detailContent="form.lvDescribe" @quillEditorUploaderImgSon="quillEditorUploaderImg"> </quill-editor>
            </el-form-item>
        </el-form>
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    lvCode: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    lvName: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    lvLogo: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    userLv: [{ required: true, validator: levelVal, trigger: "blur" }],
                    lvBackGround: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    lvDescribe: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    exp: [{ required: true, validator: expVal, trigger: "blur" }],
                    integralUp: [{ required: true, validator: bonusPointsVal, trigger: "blur" }]
                }
            };
        },
        computed: {
