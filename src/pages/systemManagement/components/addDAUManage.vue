        ...
        <el-form-item label="浮动百分比："  prop="floatPercentStart">
          <div class='bili'>
            <el-input
              type="number"
              placeholder="请输入"
              v-model="form.floatPercentStart"
            >
            </el-input>
            <span>至</span>
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        floatPercentEnd:[ 
          { required: true, message: '请输入浮动百分比结束值', trigger: 'change' }
        ],
        autoUpdateStatus:[ 
          { required: true, message: '请选择是否自动更新', trigger: 'blur' }
        ],
        effectStatus:[ 
