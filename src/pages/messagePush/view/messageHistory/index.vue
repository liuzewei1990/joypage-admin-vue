...
<!-- 推送历史 -->
  <div class="messageHistory">
    ...
    <message-preview ref='messagePreview' status='his' :message='form' v-if='dialogFormVisible' :dialogFormVisible='dialogFormVisible' @sure='sure' @cancel='cancel'  title='发送预览' cancelTxt='' sureTxt='确 定'></message-preview>   
  </div>
</template>
