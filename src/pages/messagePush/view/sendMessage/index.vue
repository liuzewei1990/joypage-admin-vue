    ...
    <div class="sendMessage" v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)">
        <el-form :size="size" ref="form" :rules="rules" :model="form" label-width="160px">
            ...
            <el-form-item v-if="form.pushWay[0] == 3 || form.pushWay[1] == 3" label="图片：" prop="imgUrl">
                <el-upload :model="form.imgUrl" class="upload-demo" action="customize" accept="image/*" :http-request="uploadCheckImg" :on-change="fileChange" :show-file-list="false">
                    <img v-if="imageUrl" :src="imageUrl" class="avatar" />
                    <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                </el-upload>
            </el-form-item>
            <el-form-item label="通知标题：" prop="title">
                <el-input type="textarea" placeholder="19字以内" v-model="form.title" maxlength="19" show-word-limit> </el-input>
            </el-form-item>
            <el-form-item label="通知描述：" prop="summary">
                <el-input type="textarea" placeholder="49字以内" v-model="form.summary" maxlength="49" show-word-limit> </el-input>
            </el-form-item>
            <el-form-item label="跳转地址：" prop="clickType">
                ...
                <div class="childCon">
                    ...
                    <el-form-item v-if="form.clickType == 2" label-width="" label="" prop="clickType">
                        ...
                        <!-- 产品 -->
                        <el-select
                            v-if="form.PRD_TYPE_ID == 4 || form.PRD_TYPE_ID == 5 || form.PRD_TYPE_ID == 12 || form.PRD_TYPE_ID == 14"
                            class="scrollSelect"
                            filterable
                            @change="changeLC"
                            clearable
                    ...
                    <el-form-item label-width="" v-if="form.clickType == 20" label="" prop="clickType">
                        ...
                        <quill-editor id="editor1" @onEditorChange="onEditorChangeDeal" v-model="form.dynamicDetails" @quillEditorUploaderImgSon="quillEditorUploaderImg"> </quill-editor>
                    </el-form-item>
                </div>
            </el-form-item>
            ...
            <el-form-item class="time" v-if="showTime" prop="datetime">
                <el-date-picker :clearable="clearable" v-model="form.datetime" type="datetime" format="yyyy-MM-dd HH:mm:ss" value-format="yyyy-MM-dd_HH:mm:ss" placeholder="选择日期时间">
                </el-date-picker>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    clickType: [{ required: true, message: "请输入跳转地址", trigger: "blur" }],
                    infoType: [{ validator: checkinfoType, trigger: "blur" }],
                    pushWay: [{ required: true, validator: checkpushWay, trigger: "blur" }],
                    title: [{ required: true, message: "请输入通知标题", trigger: "blur" }],
                    summary: [{ required: true, message: "请输入通知描述", trigger: "blur" }],
                    appFlag: [{ required: true, message: "请选择目标渠道", trigger: "blur" }],
                    systemType: [{ required: true, message: "请选择目标平台", trigger: "blur" }],
                    autoSend: [{ required: true, message: "请选择发送时间", trigger: "blur" }],
                    datetime: [{ required: true, message: "请选择发送时间", trigger: "blur" }],
                    pushType: [{ required: true, validator: checkPerson, trigger: "blur" }]
                },
                typeOptions: [
                    {
                        name: "系统消息",
                ...
                this.$refs["form"].validate((valid) => {
                    ...
                    if (valid) {
                        ...
                        if (this.form.clickType === "1" && this.form.pushUrl === "") {
                            ...
                            this.form.clickType === "2" &&
                            (this.form.PRD_TYPE_ID === "" || this.form.PRD_TYPE_ID == 4 || this.form.PRD_TYPE_ID == 5 || this.form.PRD_TYPE_ID == 12 || this.form.PRD_TYPE_ID == 14) &&
                            this.form.prdIndexId === ""
                        ) {
                            this.$message.error("请完善跳转地址");
