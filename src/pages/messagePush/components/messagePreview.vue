    ...
    <div class='dialogCon'>
      ...
      <ul>
        ...
        <li>
          ...
          <span class="value" v-if='message.clickType==="2"&&(message.PRD_TYPE_ID=="4"||message.PRD_TYPE_ID=="5"||message.PRD_TYPE_ID=="12"||message.PRD_TYPE_ID=="14")'>站内（{{message.PRD_NAME}}）</span>
          ...
          <div class="value" v-if='message.clickType==="20"'>自定义（ <div v-html='message.dynamicDetails'></div> ）</div>
        </li>
        <li>
