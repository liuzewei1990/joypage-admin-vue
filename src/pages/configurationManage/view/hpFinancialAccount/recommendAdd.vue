        ...
        <el-form :model="addFromData" :rules="rules" ref="addFromData" label-width="150px" :size="size">
            ...
            <div v-show="type == 1">
                <el-form-item label="选择机构" prop="orgId" :required="type == 1 ? true : false">
                    <BcSelect @GetApiData="orgSelectData($event)" v-model="addFromData.orgId" :filterable="true" @change="orgIdOnChange" placeholder="请输入/选择机构" :clearable="true"> </BcSelect>
                </el-form-item>
            ...
            <div v-show="type == 2">
                <el-form-item label="跳转类型" prop="contentType" :required="type == 2 ? true : false">
                    <BcSelect @GetApiData="JumpTap($event)" @change="JumpTapChange" v-model="addFromData.contentType" placeholder="请选择跳转类型" :clearable="true"> </BcSelect>
                </el-form-item>
            ...
            <el-form-item label="可见用户" prop="advVisibleUesr">
                <BcSelect @GetApiData="advVisibleUesrChange" v-model="addFromData.advVisibleUesr" :list="advVisibleUesrList" :clearable="true" placeholder="请选择可见用户"> </BcSelect>
            </el-form-item>
            ...
            <el-form-item label="投放渠道" prop="appFlag">
                ...
                <BcSelect v-model="addFromData.appFlag" :list="appFlagList" :multiple="true" :clearable="true" placeholder="请选择投放渠道"> </BcSelect>
            </el-form-item>
            ...
            submitForm(addFromData) {
                this.$refs[addFromData].validate((valid) => {
                    if (valid) {
                        ...
                        if (this.type == 1) {
                            advImgUrl = "";
                            (orgId = this.addFromData.orgId ? this.addFromData.orgId.id : ""), (prdIndexId = this.addFromData.prdIndexId ? this.addFromData.prdIndexId.id : "");
                            contentType = "";
                            contentTypeName = "";
                            content = "";
                            contentName = "";
