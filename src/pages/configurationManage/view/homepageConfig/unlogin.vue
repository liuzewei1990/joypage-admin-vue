            ...
            <div slot="search">
                <el-form :inline="true" :size="size" ref="topData">
                    ...
                    <el-form-item label="功能开关：" prop="switch">
                        ...
                        <el-switch v-model="topCheckData.switch" class="switch" :active-value="0" :inactive-value="1" active-text="YES" inactive-text="NO" @change="updateSwitch()"></el-switch>
                    </el-form-item>
                </el-form>
            </div>
            <!-- 操作按钮区 -->
            ...
            <el-form :model="dataForm" label-width="auto" :rules="formRules" ref="dataForm" :size="size" label-position="left" class="addForm">
                ...
                <el-form-item label="内容：">
                    <el-form-item label="类型：" prop="contentType">
                        <el-select v-model="dataForm.contentType" placeholder="请选择" filterable clearable @change="changeContentType">
                            <el-option v-for="item in allSelectData.contentTypeList" :key="item.value" :label="item.name" :value="item.value"> </el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="内容：" prop="content" style="position: relative">
                        ...
                        <el-select
                            ...
                            clearable
                            v-else
                            v-model="dataForm.contentName"
                            :filterable="dataForm.contentType == 3"
                            remote
                            @blur="blurFun"
