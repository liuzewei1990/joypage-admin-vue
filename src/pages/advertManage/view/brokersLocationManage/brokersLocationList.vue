<template>
    ...
    <div class="prdSeries">
        ...
        <!-- 父表格内容栏 -->
        <el-table height="200px" size="mini" :data="positionList" style="width: 100%" stripe border="true" @selection-change="selectionChange" v-loading="" element-loading-text="loading...">
            ...
            <el-form :model="dataForm" label-width="auto" :rules="formRules" ref="dataForm" :size="size" label-position="left" class="addForm">
                ...
                <el-form-item label="显示类型：" prop="showType">
                    <el-select v-model="dataForm.showType" placeholder="请选择显示类型" clearable>
                        <el-option v-for="item in allSelectData.showTypeList" :key="item.name" :label="item.name" :value="item.id"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="投放渠道：" prop="appFlag">
                    <el-select v-model="dataForm.appFlag" placeholder="请选择投放渠道" multiple clearable>
                        <el-option v-for="item in allSelectData.appFlagList" :key="item.name" :label="item.name" :value="item.id"> </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="发布设备：" prop="advPlatform">
                    <el-select v-model="dataForm.advPlatform" placeholder="请选择发布设备" multiple clearable>
                        <el-option v-for="item in allSelectData.advPlatformList" :key="item.name" :label="item.name" :value="item.id"> </el-option>
                    </el-select>
                </el-form-item>
            </el-form>
        ...
        data() {
            return {
                ...
                formRules: {
                    ...
                    showType: [{ required: true, message: "请选择类型", trigger: "change" }],
                    appFlag: [{ required: true, message: "请选择渠道", trigger: "change" }],
                    advPlatform: [{ required: true, message: "请选择设备", trigger: "change" }]
                }
            };
        },
        watch: {
