    ...
    <section>
        ...
        <el-form :model="addFromData" :rules="rules" ref="addFromData" label-width="150px" :size="size">
            ...
            <el-form-item label="所属机构" prop="orgId">
                <BcSelect @GetApiData="orgSelectData($event)" v-model="addFromData.orgId" :filterable="true" placeholder="请输入/选择机构" itemNameKey="org_name" itemValueKey="id" :clearable="true">
                </BcSelect>
            </el-form-item>
            ...
            <el-form-item label="类型" prop="contentType">
                ...
                <BcSelect @GetApiData="JumpTap($event)" @change="JumpTapChange" v-model="addFromData.contentType" placeholder="请选择类型" itemNameKey="name" itemValueKey="value" :clearable="true">
                </BcSelect>
            </el-form-item>
            ...
            <el-form-item label="可见用户" prop="advVisibleUesr">
                <BcSelect @GetApiData="advVisibleUesrChange($event)" v-model="addFromData.advVisibleUesr" itemNameKey="name" itemValueKey="value" placeholder="请选择可见用户" :clearable="true">
                </BcSelect>
            </el-form-item>
