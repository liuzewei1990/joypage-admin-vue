            ...
            <div class='content'>
              ...
              <ul>
                ...
                <div v-if='item1.userRegStatus!=""&&item1.userRegStatus!=null'>
                  ...
                  <!-- 注册时间 -->
                  <li v-if='(item1.regConnectionSymbol!=""&&item1.regConnectionSymbol!=null)||item1.userRegStatus==1'>已注册；{{item1.regStartSymbol}}{{item1.regStartTime}}{{item1.regConnectionSymbol==1?"且":""}}{{item1.regConnectionSymbol==2?"或":""}}{{item1.regEndSymbol}}{{item1.regEndTime}}</li>
                  <li v-else-if='(item1.regStartTime!=""&&item1.regStartTime!=null)||item1.userRegStatus==1'>已注册；{{item1.regStartSymbol}}{{item1.regStartTime}}</li>
