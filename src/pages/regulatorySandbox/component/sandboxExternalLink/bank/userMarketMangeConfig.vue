    ...
    <div class="config">
        ...
        <el-form :size="size" ref="form" :rules="rules" :model="form" label-width="180px">
            ...
            <el-form-item prop="locationNotObtained">
                ...
                <el-switch v-model="form.locationNotObtained" active-color="#13ce66" inactive-color="#ccc"> </el-switch>
            </el-form-item>
            <el-form-item label="比财注册状态与时间：" prop="RegTime">
                <div class="staTime">
                    ...
                    <div>
                        <span>配置时间：</span>
                        <!-- >,<,<=,>= -->
                        <el-select v-model="form.regStartSymbol" class="fanwei" :disabled="form.userRegStatus == '' || form.userRegStatus == '0'" clearable>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                EndtimeString: 0,
                rules: {
                    buyStatus: [{ required: true, message: "请选择可购买状态", trigger: "change" }],
                    eareVl: [{ required: true, validator: eareVlVal, trigger: "change" }],
                    buyPromptText: [{ required: true, message: "请填写被监管提示文案", trigger: "change" }],
                    activityIds: [{ required: true, message: "请选择活动", trigger: "change" }],
