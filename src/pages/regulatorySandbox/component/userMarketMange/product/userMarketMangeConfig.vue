  ...
  <div class='config'>
    ...
    <el-form  :size='size' ref="form" :rules="rules" :model="form" label-width="180px">
      ...
      <el-form-item label='年龄：' prop='age' v-if="newNeedStatus">
        <div class='ageDiv'>
          <div>
            <el-select clearable v-model='form.ageStartSymbol' class='fanwei'>
          ...
          <div>
            <el-select clearable v-model='form.ageEndSymbol' class='fanwei'>
              <el-option value='<' label='<'></el-option>
              <el-option value='>' label='>'></el-option>
              <el-option  value='<=' label='<='></el-option>
              <el-option  value='>=' label='>='></el-option>
      ...
      <el-form-item label='比财注册状态与时间：' prop='RegTime'>
        <div class='staTime'>
          ...
          <div v-if="newNeedStatus">
            <span>配置时间：</span>
            <!-- >,<,<=,>= -->
            <el-select :disabled='form.userRegStatus==""||form.userRegStatus=="0"' v-model='form.regStartSymbol' clearable class='fanwei'>
              <el-option value='<' label='<'></el-option>
              <el-option value='>' label='>'></el-option>
              <el-option  value='<=' label='<='></el-option>
              <el-option  value='>=' label='>='></el-option>
            ...
            <el-select :disabled='form.userRegStatus==""||form.userRegStatus=="0"' v-model='form.regEndSymbol' clearable  class='fanwei'>
              <el-option value='<' label='<'></el-option>
              <el-option value='>' label='>'></el-option>
              <el-option  value='<=' label='<='></el-option>
              <el-option  value='>=' label='>='></el-option>
      ...
      <template v-if="newNeedStatus">
        ...
        <el-form-item label='比财持仓峰值：' prop='BCFZ'>
          <div class='chicangfengzhi'>
            <div>
              <el-select v-model='form.holdSharesPeakValueStartSymbol' clearable class='fanwei'>
                <el-option value='<' label='<'></el-option>
                <el-option value='>' label='>'></el-option>
                <el-option  value='<=' label='<='></el-option>
                <el-option  value='>=' label='>='></el-option>
            ...
            <div>
              <el-select v-model='form.holdSharesPeakValueEndSymbol' clearable class='fanwei'>
                <el-option value='<' label='<'></el-option>
                <el-option value='>' label='>'></el-option>
                <el-option  value='<=' label='<='></el-option>
                <el-option  value='>=' label='>='></el-option>
      ...
      <template v-if="newNeedStatus">
        ...
        <el-form-item label='本银行持仓峰值：' prop="BYHFZ">
          <div class='chicangfengzhi'>
            <div>
              <el-select v-model='form.localBankHoldPeakValueStartSymbol' clearable class='fanwei'>
                <el-option value='<' label='<'></el-option>
                <el-option value='>' label='>'></el-option>
                <el-option  value='<=' label='<='></el-option>
                <el-option  value='>=' label='>='></el-option>
            ...
            <div>
              <el-select v-model='form.localBankHoldPeakValueEndSymbol' clearable class='fanwei'>
                <el-option value='<' label='<'></el-option>
                <el-option value='>' label='>'></el-option>
                <el-option  value='<=' label='<='></el-option>
                <el-option  value='>=' label='>='></el-option>
            ...
            <div>
              ...
              <div v-if='item.dateType=="2"'>
                ...
                <el-time-picker
                  v-model="item.dateStart"
                  format="HH:mm:ss"
                  default-value='2017-12-12 00:00:00'
                  value-format="yyyy-MM-dd HH:mm:ss"
                  placeholder="开始时间">
                </el-time-picker>
                <el-time-picker
                  v-model="item.dateEnd"
                  format="HH:mm:ss"
                  default-value='2017-12-12 23:59:59'
                  value-format="yyyy-MM-dd HH:mm:ss"
                  placeholder="结束时间">
                </el-time-picker>
              </div>
      ...
      <el-form-item label='广告位：'>
        <el-select v-model="form.displayConditon.advLocations" filterable multiple clearable placeholder="请选择广告位">
          <el-option v-for='item in advList' :key='item.id' :label="item.name" :value="item.id.toString()"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label='创新层：'>
        <el-radio v-model="form.combinationCheck" @click.native.prevent="radioClicCheckS('1')"  label="1">组合购买</el-radio>
      </el-form-item>
...
export default {
  ...
  data () {
    ...
    var ageVal= (rule, value, callback) =>{
      ...
      if (((this.form.ageEndSymbol!=''&&this.form.ageEndSymbol!=null)&&this.form.userEndAge!="")&&((this.form.ageStartSymbol!=''&&this.form.ageStartSymbol!=null)&&this.form.userStartAge!="")&&(this.form.ageConnSymbol==""||this.form.ageConnSymbol==null)) {
        isOk='请选择关联符号'
      }
      if ((this.form.ageConnSymbol!=""&&this.form.ageConnSymbol!=null)&&(this.form.ageEndSymbol==''||this.form.userEndAge==""||this.form.ageStartSymbol==''||this.form.userStartAge=="")) {
        isOk='符号和年龄不能为空'
      }
    ...
    var BCFZVal= (rule, value, callback) =>{
      ...
      if ((this.form.holdSharesPeakValueStartAmount!=""&&this.form.holdSharesPeakValueStartAmount.indexOf('.')>=0 && (this.form.holdSharesPeakValueStartAmount.split(".")[1].length>2|| this.form.holdSharesPeakValueStartAmount.split(".")[1].length==0))||(this.form.holdSharesPeakValueEndAmount!=""&&this.form.holdSharesPeakValueEndAmount.indexOf('.')>=0 && (this.form.holdSharesPeakValueEndAmount.split(".")[1].length>2|| this.form.holdSharesPeakValueEndAmount.split(".")[1].length==0))) {
        isOk='请填写正确的金额'
      } else if ((this.form.holdSharesPeakValueStartAmount!=""&&(isNaN(this.form.holdSharesPeakValueStartAmount)||!reg.test(this.form.holdSharesPeakValueStartAmount)))||(this.form.holdSharesPeakValueEndAmount!=""&&(isNaN(this.form.holdSharesPeakValueEndAmount)||!reg.test(this.form.holdSharesPeakValueEndAmount)))) {
         isOk='请填写正确的金额'
     ...
     else if ((this.form.holdSharesPeakValueStartSymbol!=''&&this.form.holdSharesPeakValueStartAmount=="")||(this.form.holdSharesPeakValueStartSymbol==''&&this.form.holdSharesPeakValueStartAmount!="")) {
        isOk='符号和金额需要同时填写'
      }
      else if ((this.form.holdSharesPeakValueEndSymbol!=''&&this.form.holdSharesPeakValueEndAmount=="")||(this.form.holdSharesPeakValueEndSymbol==''&&this.form.holdSharesPeakValueEndAmount!="")) {
        isOk='符号和金额需要同时填写'
      }
      else if ((this.form.holdSharesPeakValueStartSymbol!=''&&this.form.holdSharesPeakValueStartAmount!="")&&(this.form.holdSharesPeakValueEndSymbol!=''&&this.form.holdSharesPeakValueEndAmount!="")&&(this.form.holdSharesPeakValueConnSymbol=="")) {
        isOk='请选择关联符号'
      }
     else  if ((this.form.holdSharesPeakValueConnSymbol!="")&&(this.form.holdSharesPeakValueStartSymbol==''||this.form.holdSharesPeakValueStartAmount==""||this.form.holdSharesPeakValueEndSymbol==''||this.form.holdSharesPeakValueEndAmount=="")) {
        isOk='符号和金额不能为空'
      }
    ...
    var BYHFZVal= (rule, value, callback) =>{
      ...
      if ((this.form.localBankHoldPeakValueStartAmount!=""&&this.form.localBankHoldPeakValueStartAmount.indexOf('.')>=0 && (this.form.localBankHoldPeakValueStartAmount.split(".")[1].length>2|| this.form.localBankHoldPeakValueStartAmount.split(".")[1].length==0))||(this.form.localBankHoldPeakValueEndAmount!=""&&this.form.localBankHoldPeakValueEndAmount.indexOf('.')>=0 && (this.form.localBankHoldPeakValueEndAmount.split(".")[1].length>2|| this.form.localBankHoldPeakValueEndAmount.split(".")[1].length==0))) {
        isOk='请填写正确的金额'
      } else if ((this.form.localBankHoldPeakValueStartAmount!=""&&(isNaN(this.form.localBankHoldPeakValueStartAmount)||!reg.test(this.form.localBankHoldPeakValueStartAmount)))||(this.form.localBankHoldPeakValueEndAmount!=""&&(isNaN(this.form.localBankHoldPeakValueEndAmount)||!reg.test(this.form.localBankHoldPeakValueEndAmount)))) {
         isOk='请填写正确的金额'
      } else if (newStart.length>9||newEnd.length>9) {
        isOk='请填写正确的金额,最多9位'
      }
      else if ((this.form.localBankHoldPeakValueStartSymbol!=''&&this.form.localBankHoldPeakValueStartAmount=="")||(this.form.localBankHoldPeakValueStartSymbol==''&&this.form.localBankHoldPeakValueStartAmount!="")) {
        isOk='符号和金额需要同时填写'
      }
      else if ((this.form.localBankHoldPeakValueEndSymbol!=''&&this.form.localBankHoldPeakValueEndAmount=="")||(this.form.localBankHoldPeakValueEndSymbol==''&&this.form.localBankHoldPeakValueEndAmount!="")) {
        isOk='符号和金额需要同时填写'
      }
     else if ((this.form.localBankHoldPeakValueStartSymbol!=''&&this.form.localBankHoldPeakValueStartAmount!="")&&(this.form.localBankHoldPeakValueEndSymbol!=''&&this.form.localBankHoldPeakValueEndAmount!="")&&(this.form.localBankHoldPeakValueConnSymbol=="")) {
        isOk='请选择关联符号'
      }
     else if ((this.form.localBankHoldPeakValueConnSymbol!="")&&(this.form.localBankHoldPeakValueStartSymbol==''||this.form.localBankHoldPeakValueStartAmount==""||this.form.localBankHoldPeakValueEndSymbol==''||this.form.localBankHoldPeakValueEndAmount=="")) {
        isOk='符号和金额不能为空'
      }
      if (isOk==0) {
        callback();
    ...
    return {
      ...
      rules: {
        ...
        positionAndTime:[ 
          { required: false, validator: positionAndTimeVal, trigger: 'change' }
        ],
        positionTime:[ 
        ...
        age:[ 
          { required: false, validator: ageVal, trigger: 'blur' }
        ],
        RegTime:[ 
          { required: false, validator: RegTimeVal, trigger: 'blur' }
        ],
        BCFZ:[ 
          { required: false, validator: BCFZVal, trigger: 'blur' }
        ],
        BYHFZ:[ 
          { required: false, validator: BYHFZVal, trigger: 'blur' }
        ],
      }
    }
  },
  ...
  methods: {
    ...
    dataFun () {
      ...
      this.formData=JSON.parse(this.formData)
        ...
        console.log('combinationCheck',this.formData)
        // if (this.formData.combinationCheck=='1') {
        //   this.formData.combinationCheck=true
        // } else {
        //   this.formData.combinationCheck=false
        // }
...
// console.log("from",this.form)
  ...
  async selectGetFun () {
    ...
    radioClicCheckS (e) {
      // console.log(e)
      // console.log(this.form.combinationCheck)
      e === this.form.combinationCheck? (this.form.combinationCheck = ''):(this.form.combinationCheck = e)
    },
    radioClickPOAS (e){
