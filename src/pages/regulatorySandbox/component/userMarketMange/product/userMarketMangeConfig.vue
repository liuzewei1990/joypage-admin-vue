                    ...
                    <div style="display: flex" v-if="newNeedStatus">
                        ...
                        <div>
                            ...
                            <div v-if="item.dateType == '2'">
                                ...
                                <el-time-picker v-model="item.dateStart" format="HH:mm:ss" default-value="2017-12-12 00:00:00" value-format="yyyy-MM-dd HH:mm:ss" placeholder="开始时间">
                                </el-time-picker>
                                <el-time-picker v-model="item.dateEnd" format="HH:mm:ss" default-value="2017-12-12 23:59:59" value-format="yyyy-MM-dd HH:mm:ss" placeholder="结束时间">
                                </el-time-picker>
                            </div>
                        </div>
                    </div>
