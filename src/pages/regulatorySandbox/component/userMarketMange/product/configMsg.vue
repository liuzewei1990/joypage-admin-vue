<template>
    ...
    <div>
        <div class="contentDiv">
                        ...
                        <div class="addBigother" v-else>
                            <div class="content">
                                ...
                                <ul>
                                    ...
                                    <div
                                        v-if="
                                            (item1.ageConnSymbol == '' || item1.ageConnSymbol == null) &&
                                            (item1.userStartAge == '' || item1.userStartAge == null) &&
                                            (item1.userEndAge == '' || item1.userEndAge == null)
                                        "></div>
                                    <div v-else>
                                        <span>年龄：</span>
                                        <li>
                                            {{ item1.ageStartSymbol }}{{ item1.userStartAge }}{{ item1.userStartAge == "" || item1.userStartAge == null ? "" : "岁"
                                            }}{{ item1.ageConnSymbol == 1 ? "且" : "" }}{{ item1.ageConnSymbol == 2 ? "或" : "" }}{{ item1.ageEndSymbol }}{{ item1.userEndAge
                                            }}{{ item1.userEndAge == "" || item1.userEndAge == null ? "" : "岁" }}
                                        </li>
                                    </div>
                                    ...
                                    <div
                                        v-if="
                                            (item1.userRegStatus != '' && item1.userRegStatus != null) ||
                                            (item1.realNameStatus != '' && item1.realNameStatus != null) ||
                                            (item1.openAccountStatus != '' && item1.openAccountStatus != null) ||
                                            (item1.investmentStatus != '' && item1.investmentStatus != null) ||
                                            (item1.holdSharesStatus != '' && item1.holdSharesStatus != null)
                                        ">
                                        <span>比财：</span>
                                        ...
                                        <li v-if="(item1.regConnectionSymbol != '' && item1.regConnectionSymbol != null) || item1.userRegStatus == 1">
                                            已登陆：{{ item1.regStartSymbol }}{{ item1.regStartTime }}
                                    ...
                                    <div
                                        v-if="
                                            (item1.holdSharesPeakValueStartAmount != '' && item1.holdSharesPeakValueStartAmount != null) ||
                                            (item1.holdSharesPeakValueEndAmount != '' && item1.holdSharesPeakValueEndAmount != null) ||
                                            (item1.localBankHoldPeakValueStartAmount != '' && item1.localBankHoldPeakValueStartAmount != null) ||
                                            (item1.localBankHoldPeakValueEndAmount != '' && item1.localBankHoldPeakValueEndAmount != null)
                                        ">
                                        <span>持仓峰值金额：</span>
                                        <li
                                            v-if="
                                                ...
                                                (item1.holdSharesPeakValueEndAmount != '' && item1.holdSharesPeakValueEndAmount != null)
                                            ">
                                            比财：{{ item1.holdSharesPeakValueStartSymbol }}{{ item1.holdSharesPeakValueStartAmount }}
                                            {{ item1.holdSharesPeakValueConnSymbol == 1 ? "且" : "" }}
                                            {{ item1.holdSharesPeakValueConnSymbol == 2 ? "或" : "" }}
                                            {{ item1.holdSharesPeakValueEndSymbol }}{{ item1.holdSharesPeakValueEndAmount }}
                                        </li>
                                        ...
                                        <li
                                            v-if="
                                                ...
                                                (item1.localBankHoldPeakValueEndAmount != '' && item1.localBankHoldPeakValueEndAmount != null)
                                            ">
                                            本银行：{{ item1.localBankHoldPeakValueStartSymbol }}{{ item1.localBankHoldPeakValueStartAmount }}
                                            <span v-if="item1.localBankHoldPeakValueConnSymbol == 1">且</span>
                                            <span v-if="item1.localBankHoldPeakValueConnSymbol == 2">或</span>
                                            {{ item1.localBankHoldPeakValueEndSymbol }}{{ item1.localBankHoldPeakValueEndAmount }}
                                        </li>
                                    </div>
                                    ...
                                    <div
                                        v-if="
                                            (item1.localBankOpenAccountStatus != '' && item1.localBankOpenAccountStatus != null) ||
                                            (item1.localBankInvestmentStatus != '' && item1.localBankInvestmentStatus != null) ||
                                            (item1.localBankHoldSharsStatus != '' && item1.localBankHoldSharsStatus != null)
                                        ">
                                        <span>本银行：</span>
                                        <li v-if="item1.localBankOpenAccountStatus != '' && item1.localBankOpenAccountStatus != null">
                                            {{ item1.localBankOpenAccountStatus == "1" ? "已开户" : "未开户" }}
                                        </li>
                                        <!-- 本银行的投资状态1投0未投 -->
                                        <li v-if="item1.localBankInvestmentStatus != '' && item1.localBankInvestmentStatus != null">
                                            {{ item1.localBankInvestmentStatus == "1" ? "已投资" : "未投资" }}
                                        </li>
                                        <!-- 本银行的持仓状态 1持仓0未持 -->
                    ...
                    <p>
                      <span v-if='item2.dateType==2'>展示周期：
                        ...
                        <span v-if='item2.weekCode.toString().indexOf("7")>=0'>周日 {{item2.dateStart.split(" ")[1]}}~{{item2.dateEnd.split(" ")[1]}}</span>
                                    ...
                                    <div v-if="item1.displayConditon.advLocations != '' && item1.displayConditon.advLocations != null">
                                        <span>广告位：</span>
                                        <li>{{ item1.displayConditon.advLocationNameList.toString() }}</li>
                                    </div>
                                    <div v-if="item1.displayConditon.actLocations != '' && item1.displayConditon.actLocations != null">
                                        <span>活动：</span>
                                        <li>{{ item1.displayConditon.actLocationNameList.toString() }}</li>
                                    </div>
                                    <div v-if="item1.displayConditon.contents != '' && item1.displayConditon.contents != null">
                                        <span>内容：</span>
            ...
            <div v-for="(items, index5) in newYIMsg" :key="index5">
                <div class="addSmall" v-if="index5 == newYIMsg.length - 1">
            ...
            <div style="margin-top: 20px" v-if="showtwoLevelUserCondition">
                                    ...
                                    <ul>
                                        ...
                                        <div
                                            ...
                                            <li
                                                ...
                                                本银行：{{ item1.localBankHoldPeakValueStartSymbol }}{{ item1.localBankHoldPeakValueStartAmount }}
                                                <span v-if="item1.localBankHoldPeakValueConnSymbol == 1">且</span>
                                                <span v-if="item1.localBankHoldPeakValueConnSymbol == 2">或</span>{{ item1.localBankHoldPeakValueEndSymbol }}{{ item1.localBankHoldPeakValueEndAmount }}
                                            </li>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <!-- 本银行的持仓状态 1持仓0未持 -->
                                            <li v-if="item1.localBankHoldSharsStatus != '' && item1.localBankHoldSharsStatus != null">
                                                {{ item1.localBankHoldSharsStatus == "1" ? "已持仓" : "未持仓" }}
                                            </li>
                                        </div>
                    ...
                    <p>
                      <span v-if='item2.dateType==2'>展示周期：
                        ...
                        <span v-if='item2.weekCode.toString().indexOf("7")>=0'>周日 {{item2.dateStart.split(" ")[1]}}~{{item2.dateEnd.split(" ")[1]}}</span>
                                        ...
                                        <li v-if="item1.displayConditon.advLocations != '' && item1.displayConditon.advLocations != null">
                                            广告位：{{ item1.displayConditon.advLocationNameList.toString() }}
                                        </li>
                                        <li v-if="item1.displayConditon.actLocations != ''">活动：{{ item1.displayConditon.actLocationNameList.toString() }}</li>
                                        <li v-if="item1.displayConditon.contents != ''">内容：{{ item1.displayConditon.contentNameList.toString() }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div v-for="(items, index5) in newERMsg" :key="index5">
                    <div class="addSmall" v-if="index5 == newERMsg.length - 1">
        ...
        <el-dialog title="配置条件" fullscreen modal="false" width="90%" destroy-on-close="true" :visible.sync="dialogVisible">
...
<script>
    ...
    import { BankPrdselectOne, MCselectOne } from "../../../apis/index";
    export default {
        ...
        computed: {
            ...
            newERMsg() {
                return this.twoLevelUserCondition.filter((i) => i.dataType != "3");
            },
            newYIMsg() {
                return this.oneLevelUserCondition.filter((i) => i.dataType != "3");
            }
        },
        methods: {
            // 切换状态
            ...
            deleteFun(type, index, id) {
                console.log(this.twoLevelUserCondition.filter((i) => i.dataType != "3"));
                if (type == "oneLevelUserCondition") {
