                                        ...
                                        <div
                                            ...
                                            <li
                                                v-if="
                                                    ...
                                                    (item1.holdSharesPeakValueEndAmount != '' && item1.holdSharesPeakValueEndAmount != null)
                                                ">
                                                比财：{{ item1.holdSharesPeakValueStartSymbol }}{{ item1.holdSharesPeakValueStartAmount }} {{ item1.holdSharesPeakValueConnSymbol == 1 ? "且" : ""
                                                }}{{ item1.holdSharesPeakValueConnSymbol == 2 ? "或" : "" }} {{ item1.holdSharesPeakValueEndSymbol }}{{ item1.holdSharesPeakValueEndAmount }}
                                            </li>
