    ...
    <div class="addBank" v-loading="loading">
        ...
        <el-form :size="size" ref="form" :rules="rules" :model="form" label-width="160px">
            <el-form-item label="银行" prop="orgId">
                <el-select :disabled="$route.query.name == '修改'" v-model="form.orgId" filterable clearable placeholder="请选择">
...
<script>
    import configMsg from "../../../component/userMarketMange/bank/configMsg";
    import alertPop from "../../../component/userMarketMange/alertPOP";
    import { BankPrdselectOne, BankPrdsave, org, BankPrdcheckExist } from "../../../apis/index";
    export default {
                    ...
                    if (valid) {
                        this.configMsgData.oneLevelUserCondition.forEach((element) => {
                            if (element.id) {
                                let obj = {
                                    id: element.id,
                                    condConnSymbol: element.condConnSymbol == "" || element.condConnSymbol == null ? null : Number(element.condConnSymbol),
