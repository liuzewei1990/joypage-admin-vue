...
export default {
  ...
  data () {
    ...
    var configMsgVal = (rule, value, callback) => {
      ...
      if (this.configMsgData.oneLevelUserCondition==undefined) {
        ...
        this.configMsgData.oneLevelUserCondition.filter(a => a.dataType!='3' &&a.conditionVisible!='').forEach((i,index) => {
        ...
        this.configMsgData.twoLevelUserCondition.filter(a => a.dataType!='3' &&a.conditionVisible!='').forEach((i,index) => {
  ...
  methods: {
    ...
    sumFun () {
      ...
      this.configMsgData.oneLevelUserCondition.filter(a => a.dataType!='3' &&a.conditionVisible!='').forEach((i) => {
        if (this.configMsgData.twoLevelUserCondition.filter(i => i.dataType!='3'&&i.conditionVisible!='' ).length==1&&this.configMsgData.twoLevelUserCondition.filter(i => i.dataType!='3' &&i.conditionVisible!='')[0].conditionVisible=='') {
          this.$refs.configMsgData.disabledRadio2=false
        } else {
          
          this.configMsgData.twoLevelUserCondition.filter(b => b.dataType!='3'&&b.conditionVisible!='' ).forEach((j) => {
            // debugger
            ...
            if (this.configMsgData.twoLevelUserCondition.filter(i => i.dataType!='3'&&i.conditionVisible!='' ).length>1) {
              ...
              if (twoisSame==1) {
                this.configMsgData.twoLevelUserCondition.filter(i => i.dataType!='3'&&i.conditionVisible!='' ).forEach((k) => {
                  k.condConnSymbol=2
                  console.log('k::',k)
                })
        ...
        if (this.configMsgData.oneLevelUserCondition.filter(i => i.dataType!='3'&&i.conditionVisible!='' ).length>1) {
          ...
          if (oneisSame==1) {
            this.configMsgData.oneLevelUserCondition.filter(i => i.dataType!='3'&&i.conditionVisible!='' ).forEach((k) => {
              k.condConnSymbol=2
            })
