                                    ...
                                    <div
                                        ...
                                        <li
                                            v-if="
                                                ...
                                                (item.localBankHoldPeakValueEndAmount != '' && item.localBankHoldPeakValueEndAmount != null)
                                            ">
                                            本银行：{{ item.localBankHoldPeakValueStartSymbol }}{{ item.localBankHoldPeakValueStartAmount }} {{ item.localBankHoldPeakValueConnSymbol == 1 ? "且" : ""
                                            }}{{ item.localBankHoldPeakValueConnSymbol == 2 ? "或" : "" }} {{ item.localBankHoldPeakValueEndSymbol }}{{ item.localBankHoldPeakValueEndAmount }}
                                        </li>
                                    </div>
                            ...
                            <div class="content">
                                ...
                                <ul>
                                    ...
                                    <div
                                        ...
                                        <span>本银行：</span>
                                        <li v-if="item.localBankOpenAccountStatus != '' && item.localBankOpenAccountStatus != null">
                                            {{ item.localBankOpenAccountStatus == "1" ? "本银行：已开户" : "本银行：未开户" }}
                                        </li>
                                        <!-- 本银行的投资状态1投0未投 -->
                                        <li v-if="item.localBankInvestmentStatus != '' && item.localBankInvestmentStatus != null">
                                            {{ item.localBankInvestmentStatus == "1" ? "本银行：已投资" : "本银行：未投资" }}
                                        </li>
                                        <!-- 本银行的持仓状态 1持仓0未持 -->
                                        <li v-if="item.localBankHoldSharsStatus != '' && item.localBankHoldSharsStatus != null">
                                            {{ item.localBankHoldSharsStatus == "1" ? "本银行：已持仓" : "本银行：未持仓" }}
                                        </li>
                                    </div>
