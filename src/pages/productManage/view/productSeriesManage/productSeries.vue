                ...
                <el-form :inline="true" :model="topCheckData" :size="size" ref="topData">
                    <el-form-item label="机构名称：" prop="orgName">
                        <el-select v-model="topCheckData.orgName" placeholder="请选择机构名称" filterable clearable>
                            <el-option v-for="item in allSelectData.orgList" :key="item.ID" :label="item.ORG_NAME" :value="item.ORG_NAME"> </el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="产品大类：" prop="parentTypeCode">
                        <el-select v-model="topCheckData.parentTypeCode" placeholder="请选择产品大类" clearable @change="parentTypeListSelect">
                            <el-option v-for="item in allSelectData.parentTypeList" :key="item.typeCode" :label="item.typeName" :value="item.typeCode"> </el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="存款类型：" prop="typeCode">
                        <el-select v-model="topCheckData.typeCode" placeholder="请选择存款类型" clearable @change="allSubTypeListSelect">
        ...
        <el-dialog :title="!dataForm.ID ? '新增' : '修改'" width="60%" :visible.sync="dialogVisible" :before-close="closeDialog">
            <el-form :model="dataForm" label-width="auto" :rules="formRules" ref="dataForm" :size="size" label-position="left" class="addForm">
                <el-form-item label="机构名称：" prop="ORG_ID">
                    <el-select v-model="dataForm.ORG_ID" placeholder="请选择机构名称" filterable clearable @change="orgListSelect">
                ...
                <el-form-item label="同系列标签是否同步：" prop="AUTO_LABEL">
                    <el-select v-model="dataForm.AUTO_LABEL" placeholder="请选择" clearable>
                        <el-option v-for="item in autoLableList" :key="item.value" :label="item.label" :value="item.value"> </el-option>
                    </el-select>
                </el-form-item>
        ...
        data() {
            return {
                ...
                formRules: {
                    ...
                    AUTO_LABEL: [{ required: true, message: "请选择同系列标签是否同步", trigger: "change" }]
                },
                //删除
                selections: [] //删除选中项
            };
