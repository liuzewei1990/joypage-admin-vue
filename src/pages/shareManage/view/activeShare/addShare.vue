        ...
        <el-form :size="size" ref="form" :rules="rules" :model="form" label-width="160px">
            ...
            <div v-if="form.shareType === '0'">
                <el-form-item label="分享图片上传：" prop="shareUrl">
                    <el-upload :model="form.shareUrl" class="upload-demo upload-demo1" action="customize" :http-request="uploadCheckImg1" :on-change="fileChange" :show-file-list="false">
                ...
                <el-form-item label="链接生成地址：" prop="shareUrl">
                    <el-input :disabled="true" type="text" placeholder="" v-model="form.shareUrl" maxlength="" show-word-limit></el-input>
                </el-form-item>
            </div>
            <!-- 分享方式  为小程序 -->
            <div v-if="form.shareType == 2">
                <el-form-item label="小程序链接：" prop="shareUrl">
                    <el-input type="text" placeholder="" v-model="form.shareUrl"></el-input>
                </el-form-item>
                <el-form-item label="小程序分享主题：" prop="shareTitle">
                    <el-input type="text" placeholder="" v-model="form.shareTitle"></el-input>
                </el-form-item>
                <el-form-item label="小程序分享内容：" prop="shareContent">
                    <el-input type="textarea" placeholder="" v-model="form.shareContent"></el-input>
                </el-form-item>
                <el-form-item label="小程序图片：" prop="pmpPicUrl">
                    <el-upload :model="form.pmpPicUrl" class="upload-demo upload-demo1" action="customize" :http-request="uploadCheckImgMin" :on-change="fileChange" :show-file-list="false">
                ...
                <div class="second">
                    ...
                    <el-form-item v-if="showShareMathods" label="备用链接地址：" prop="standbyShareUrl">
                        <el-input type="text" placeholder="" v-model="form.standbyShareUrl"></el-input>
                    </el-form-item>
                    <el-form-item v-if="showShareMathods" label="备用链接分享主题：" prop="standbyShareTitle">
                        <el-input type="text" placeholder="" v-model="form.standbyShareTitle"></el-input>
                    </el-form-item>
                    <el-form-item v-if="showShareMathods" label="备用链接分享内容：" prop="standbyShareContent">
                        <el-input type="text" placeholder="" v-model="form.standbyShareContent"></el-input>
                    </el-form-item>
                </div>
            </div>
            <!-- 分享方式  为链接  已对接-->
            <div v-if="form.shareType === '1'">
                ...
                <el-form-item v-if="showShareMathods" label="分享内容：" prop="shareContent">
                    <el-input type="text" placeholder="" v-model="form.shareContent"></el-input>
                </el-form-item>
            </div>
            <!--  选择短信邀请下方功能为-->
            <div v-if="form.sharePlace === '4'" class="second">
                <el-form-item label="短信发送文案：" prop="msgContent">
                    <el-input type="textarea" placeholder="" v-model="form.msgContent" maxlength="" show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="邀请间隔天数：" prop="msgIntervalDays">
                    <el-input type="text" placeholder="" v-model="form.msgIntervalDays"></el-input>
                </el-form-item>
            </div>
            ...
            <div v-if="form.sharePlace === '5'" class="second">
                ...
                <el-form-item label="二维码页分享按键文案：" prop="extendButtonText">
                    <el-input type="text" placeholder="" v-model="form.extendButtonText"></el-input>
                </el-form-item>
    ...
    export default {
        data() {
            ...
            return {
                ...
                showClose: false,
                rules: {
                    appFlag: [{ required: true, validator: checkappFlag, trigger: "blur" }],
                    deviceType: [{ required: true, validator: checksystemType, trigger: "blur" }],
                    extendDeviceType: [{ required: true, validator: checksystemType1, trigger: "blur" }],
                    sharePlace: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    activityId: [{ required: true, message: "内容不能为空", trigger: "change" }],
                    shareType: [{ required: true, message: "内容不能为空", trigger: "blur" }],

                    msgIntervalDays: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    msgContent: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    extendButtonText: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    extendSharePlace: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    standbyShareType: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    pmpPicUrl: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    standbyShareUrl: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    standbyShareTitle: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    standbyShareContent: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    shareUrl: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    shareTitle: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    shareContent: [{ required: true, message: "内容不能为空", trigger: "blur" }],
                    status: [{ required: true, message: "内容不能为空", trigger: "change" }]
                }
            };
        },
        computed: {
