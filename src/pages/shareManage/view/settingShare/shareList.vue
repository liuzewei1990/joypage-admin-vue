...
<!-- 分享管理 -->
  <div class="shareList">
    <el-form :inline="true" :size='size' class='searchForm' :model='searchForm' ref='searchForm'>
      ...
      <el-form-item label='分享设备' prop='deviceType'>
      ...
      <div class='btnCon'>
        <el-form-item>
          <el-button :size='size' icon='el-icon-plus' type="primary" @click="add">新增设置页分享</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table :data="contentList" style="width: 100%" border="true" :loading='tabLoading'>
      ...
      <el-table-column prop="appFlagStr" label="分享入口渠道" header-align="center" align="center">
      </el-table-column>
      <el-table-column prop="shareDestinationStr" label="分享至" header-align="center" align="center"></el-table-column>
      <el-table-column prop="deviceTypeStr" label="分享设备" header-align="center" align="center"></el-table-column>
