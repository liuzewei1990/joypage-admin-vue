                ...
                <el-form :inline="true" :size="size" :model="topCheckData" ref="topData">
                    <el-form-item label="基金公司名称：" prop="fundCompanyName">
                        <el-select v-model="topCheckData.fundCompanyName" placeholder="请选择" filterable clearable>
                            <el-option v-for="item in allSelectData.fundCompanyNameList" :key="item.id" :label="item.fundCompanyName" :value="item.fundCompanyName"> </el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="状态：" prop="fundStatus">
                        <el-select v-model="topCheckData.fundStatus" placeholder="请选择" filterable clearable>
                            <el-option v-for="item in allSelectData.fundStatusList" :key="item.value" :label="item.name" :value="item.value"> </el-option>
                        </el-select>
                    </el-form-item>
                </el-form>
            </div>
        ...
        <el-dialog :title="!dataForm.id ? '新增' : '修改'" width="60%" :visible.sync="dialogVisible" :before-close="closeDialog">
            <el-form :model="dataForm" label-width="auto" :rules="formRules" ref="dataForm" :size="size" label-position="left" class="addForm">
                ...
                <el-form-item label="注册时间：" prop="registDate">
                    <el-date-picker v-model="dataForm.registDate" type="date" placeholder="注册时间" format="yyyy-MM-dd" value-format="yyyy-MM-dd HH:mm:ss" style="width: 50%"></el-date-picker>
                </el-form-item>
                <el-form-item label="状态：" prop="fundStatus">
    ...
    export default {
        ...
        data() {
            return {
                ...
                formRules: {
                    //弹框校验规则
                    fundStatus: [{ required: true, message: "请选择状态", trigger: "blur" }],
                    fundCount: [{ required: true, message: "请输入旗下基金数量", trigger: "blur" }],
