<template>
    <div class="prdSeries">
        ...
        <CommonTable :isFluid="false" @height="tableHeight=$event">
            ...
            <div slot="search">
                <el-form :inline="true" :size="size" :model="listData" ref="listData">
                    ...
                    <el-select v-model="topCheckSelect" placeholder="请选择" filterable clearable>
                        <el-option v-for="item in topCheckData"
            ...
            <!-- 表格内容栏 -->
            <el-table :height="tableHeight" size="mini" style="width: 100%" :data='corgCarefullyChosenConf' stripe border="true"
