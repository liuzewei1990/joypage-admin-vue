    ...
    export default {
        ...
        data() {
            return {
                ...
                formRules: {
                    //弹框校验规则
                    orgName: [{ required: true, message: "请输入银行名称", trigger: "blur" }],
                    generalBankNo: [{ required: true, message: "请输入总行号", trigger: "blur" }]
                },
                //删除
                selections: [] //删除选中项
            };
        ...
        methods: {
            ...
            getbankList: function (type) {
                ...
                queryCommercialBankList(params)
                    .then((res) => {
