...
const CONFIG = {
    ...
    development: {
        ...
        // api host
        baseUrlHost: "/omp",
        // baseUrlHost: "http://192.168.10.212:8080/omp",
        // baseUrlHost: "http://192.168.100.249:8989",
        // baseUrlHost: "http://easy-mock.liuup.com/mock/60af30d83613fa05c7da756c/investReward",
        // api path
    ...
    production: {
        ...
        baseUrlHost: window.location.protocol + "//" + window.location.host + "/finsuit", //单独走生产环境
        // api path
        baseUrlPath: "/finsuit/finsuitPhone/deal",
        // 阿里云静态文件地址
